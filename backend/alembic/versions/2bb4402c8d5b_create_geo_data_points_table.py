"""create geo_data_points table

Revision ID: 2bb4402c8d5b
Revises: 
Create Date: 2026-04-01 08:27:16.673414
"""
...
def upgrade() -> None:
    op.create_table('geo_data_points',
    ...
    op.create_index(op.f('ix_geo_data_points_source'), 'geo_data_points', ['source'], unique=False)


def downgrade() -> None:
    op.drop_index(op.f('ix_geo_data_points_source'), table_name='geo_data_points')
    op.drop_table('geo_data_points')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_geo_data_points_source'), table_name='geo_data_points')
    op.drop_index('idx_geo_data_points_geometry', table_name='geo_data_points', postgresql_using='gist')
    op.drop_table('geo_data_points')
